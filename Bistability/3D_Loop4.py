...
drive_power_up_in=(np.loadtxt(r'F:\Chirality of encycling bistability critical point(20220726-20230503)\20230425\CP out and cross upper side change power first 13-21-58\drive power.txt'));
delta_m_up_in=(8.184-np.loadtxt(r'F:\Chirality of encycling bistability critical point(20220726-20230503)\20230425\CP out and cross upper side change power first 13-21-58\drive fre.txt'));

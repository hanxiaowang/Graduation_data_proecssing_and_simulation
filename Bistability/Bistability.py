...
axes.scatter(power,Dpowerf,label='Scan forward',color='none',edgecolors='blue',s=10,linewidth=3)
axes.scatter(power[::-1],Dpowerb,label='Scan backward',color='none',edgecolors='red',s=10,linewidth=3)
axes.plot(px0,py0,'.',label='Simulation',color='black',markersize=5)
axes.plot(px1,py1,'.',label='',color='black',markersize=5)
axes.plot(px2,py2,'.',label='',color='black',markersize=5)
axes.set_xlabel(r'$P_d$ [mW]',fontsize=10)
...
fig.patch.set_alpha(0)
axes.patch.set_alpha(0)
axes.scatter(fre[::-1],Dfref,label='Scan forward',color='none',edgecolors='blue',s=10,linewidth=3)
axes.scatter(fre,Dfreb,label='Scan backward',color='none',edgecolors='red',s=10,linewidth=3)
axes.plot(fx0,fy0,'.',label='Simulation',color='black',markersize=5)
axes.plot(fx1,fy1,'.',label='',color='black',markersize=5)
axes.plot(fx2,fy2,'.',label='',color='black',markersize=5)

...
#
drive_powers=(np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change power first at B 17-29-37\drive power.txt'));
delta_ms=(8.184-np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change power first at B 17-29-37\drive fre.txt'));
cpf_down_ins=(np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change power first at B 17-29-37\Delta omega up.txt'));
cfp_down_ins=(np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change fre first at B 17-41-26\Delta omega up.txt'));
step_downs=np.linspace(1,len(drive_powers)+1,len(drive_powers))


drive_power_up_ins=(np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change power first at B 17-41-43\drive power.txt'));
delta_m_up_ins=(8.184-np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change power first at B 17-41-43\drive fre.txt'));
cpf_up_ins=(np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change power first at B 17-41-43\Delta omega up.txt'));
cfp_up_ins=(np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change fre first at B 17-29-17\Delta omega up.txt'));
...
# fig.patch.set_alpha(0)
# axes.patch.set_alpha(0)
# axes.plot(step_in,drive_power_up[::-1],color='peru',label=r'$P_d$',linewidth=1,alpha=1,marker='o',markersize=5)
# axes2 = axes.twinx()
# axes2.plot(step_in,delta_m_up[::-1],color='purple',label=r'$\delta_m/2\pi$',linewidth=1,alpha=1,marker='o',markersize=5)

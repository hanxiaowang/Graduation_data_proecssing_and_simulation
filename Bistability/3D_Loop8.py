...
# print(len(pre_Pe))
# print(len(pre_Ps))
drive_power_in=np.concatenate((pre_Pe[::-1][370:560],pre_Pe[::-1][0:370]))
print(len(pre_Pe[::-1][370:560]))
print(len(pre_Pe[::-1][0:370]))
delta_m_in=np.concatenate((pre_deltae[::-1][370:560],pre_deltae[::-1][0:370]))
cpf_down_in=np.concatenate((pre_Delta2e[370:560],pre_Delta2e[0:370]))
cfp_down_in=np.concatenate((pre_Delta2e[370:0:-1],pre_Delta1e[0:190]))
print(len(cpf_down_in))
step_in=np.linspace(1,len(drive_power_in)+1,len(drive_power_in))



drive_power_up_in=np.concatenate((pre_Pe[190:0:-1],pre_Pe[0:370]))
delta_m_up_in=np.concatenate((pre_deltae[190:0:-1],pre_deltae[0:370]))
cpf_up_in=np.concatenate((pre_Delta1e[190:0:-1],pre_Delta2e[0:370]))
cfp_up_in=np.concatenate((pre_Delta1e[190:560],pre_Delta1e[0:190]))
print(len(cpf_up_in))
# print(len(cfp_up_in))
#
...
drive_powers=np.concatenate((pre_Ps[::-1][370:560],pre_Ps[::-1][0:370]))
delta_ms=np.concatenate((pre_deltas[::-1][370:560],pre_deltas[::-1][0:370]))
cpf_down_ins=np.concatenate((pre_Delta2s[370:560],pre_Delta2s[0:370]))
cfp_down_ins=np.concatenate((pre_Delta2s[370:0:-1],pre_Delta1s[0:190]))
print(len(cpf_down_ins))
step_downs=np.linspace(1,len(drive_powers)+1,len(drive_powers))


drive_power_up_ins=np.concatenate((pre_Ps[190:0:-1],pre_Ps[0:370]))
delta_m_up_ins=np.concatenate((pre_deltas[190:0:-1],pre_deltas[0:370]))
cpf_up_ins=np.concatenate((pre_Delta1s[190:0:-1],pre_Delta2s[0:370]))
cfp_up_ins=np.concatenate((pre_Delta1s[190:560],pre_Delta1s[0:190]))
...
np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\chirality\loop8\pe1.txt',drive_power_in)
np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\chirality\loop8\fe1.txt',delta_m_in)
np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\chirality\loop8\de1.txt',cpf_down_in)

np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\chirality\loop8\pe2.txt',drive_power_up_in)
np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\chirality\loop8\fe2.txt',delta_m_up_in)
np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\chirality\loop8\de2.txt',cpf_up_in)

np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\chirality\loop8\pe3.txt',drive_power_in)
np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\chirality\loop8\fe3.txt',delta_m_in)
np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\chirality\loop8\de3.txt',cfp_down_in)

np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\chirality\loop8\pe4.txt',drive_power_up_in)
np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\chirality\loop8\fe4.txt',delta_m_up_in)
np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\chirality\loop8\de4.txt',cfp_up_in)

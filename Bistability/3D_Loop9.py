...
#
drive_powers=(np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change power first at C 17-4-42\drive power.txt'));
delta_ms=(8.184-np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change power first at C 17-4-42\drive fre.txt'));
cpf_down_ins=(np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change power first at C 17-4-42\Delta omega up.txt'));
cfp_down_ins=(np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change fre first at C 17-4-12\Delta omega up.txt'));
step_downs=np.linspace(1,len(drive_powers)+1,len(drive_powers))


drive_power_up_ins=(np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change power first at C 17-3-51\drive power.txt'));
delta_m_up_ins=(8.184-np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change power first at C 17-3-51\drive fre.txt'));
cpf_up_ins=(np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change power first at C 17-3-51\Delta omega up.txt'));
cfp_up_ins=(np.loadtxt(r'C:\Users\AORUS\OneDrive\桌面\change fre first at C 17-5-1\Delta omega up.txt'));
...
cpf_down_in111=np.concatenate((cpf_down_in[0:300],cpf_up_in[300:601]))
print(len(cpf_down_in[0:300]))
print(len(cpf_up_in[300:600]))
print(len(cpf_down_in111))
axes.scatter(step_in,cpf_down_in111,label='Exp',marker='s',color='none',linewidth=2,edgecolors='green',s=80)

...
for i in range(len(drive_power)):
    Decay_exp=np.loadtxt(f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230411\\Bistability UP change fre 2D backward 0-35-21\\drive power={round(drive_power[i],1)}mW\\Kappa_experiment.txt')
    Decay_th=np.loadtxt(f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230411\\Bistability UP change fre 2D backward 0-35-21\\drive power={round(drive_power[i],1)}mW\\Kappa_theory.txt')
    Decay_xz=np.loadtxt(f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230411\\Bistability UP change fre 2D backward 0-35-21\\drive power={round(drive_power[i],1)}mW\\Kappa_xiuzheng.txt')

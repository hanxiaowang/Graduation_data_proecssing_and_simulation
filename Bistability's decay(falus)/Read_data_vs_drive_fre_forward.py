...
for i in range(len(drive_power)):
    print(i)
    S_2D=np.loadtxt(f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230410\\Bistability UP change fre 2D forward 11-21-59\\drive power={round(drive_power[i],1)}mW\\S_2D.txt',delimiter=',')
    ...
    for j in range(len(drive_fre)):
        ...
        np.savetxt(
            f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230410\\Bistability UP change fre 2D forward 11-21-59\\drive power={round(drive_power[i], 1)}mW\\drive fre={drive_fre[j]} S_experiment.txt',
            S_1D_part, fmt='%.6f')
        np.savetxt(
            f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230410\\Bistability UP change fre 2D forward 11-21-59\\drive power={round(drive_power[i], 1)}mW\\drive fre={drive_fre[j]} S_theory.txt',
            theory_S, fmt='%.6f')
        np.savetxt(
            f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230410\\Bistability UP change fre 2D forward 11-21-59\\drive power={round(drive_power[i], 1)}mW\\drive fre={drive_fre[j]} vna_fre_part.txt',
            vna_fre_part, fmt='%.6f')
        if j==0:
        ...
        fig_path=f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230410\\Bistability UP change fre 2D forward 11-21-59\\drive power={round(drive_power[i], 1)}mW\\drive fre={drive_fre[j]}.png'
        plt.figure()
    ...
    np.savetxt(f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230410\\Bistability UP change fre 2D forward 11-21-59\\drive power={round(drive_power[i],1)}mW\\Kappa_theory.txt',Kappa_theory,fmt='%.6f')
    np.savetxt(f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230410\\Bistability UP change fre 2D forward 11-21-59\\drive power={round(drive_power[i],1)}mW\\Kappa_experiment.txt',Kappa_experiment,fmt='%.6f')
    np.savetxt(f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230410\\Bistability UP change fre 2D forward 11-21-59\\drive power={round(drive_power[i],1)}mW\\Kappa_xiuzheng.txt',Kappa_xiuzheng,fmt='%.6f')
    np.savetxt(
        f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230410\\Bistability UP change fre 2D forward 11-21-59\\drive power={round(drive_power[i],1)}mW\\Kappa_probe_theory.txt',
        Kappa_probe_theory, fmt='%.6f')
    np.savetxt(
        f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230410\\Bistability UP change fre 2D forward 11-21-59\\drive power={round(drive_power[i],1)}mW\\Kappa_probe_experiment.txt',
        Kappa_probe_experiment, fmt='%.6f')
    np.savetxt(
        f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230410\\Bistability UP change fre 2D forward 11-21-59\\drive power={round(drive_power[i],1)}mW\\Kappa_probe_xiuzheng.txt',

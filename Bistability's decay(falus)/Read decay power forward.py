...
for i in range(len(drive_fre)):
    Decay_exp=np.loadtxt(f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230407\\Bistability UP change power 2D forward 23-54-37\\drive frequency={drive_fre[i]}GHz\\Kappa_experiment.txt')
    Decay_th=np.loadtxt(f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230407\\Bistability UP change power 2D forward 23-54-37\\drive frequency={drive_fre[i]}GHz\\Kappa_theory.txt')
    Decay_xz=np.loadtxt(f'F:\\Chirality of encycling bistability critical point(20220726-20230503)\\20230407\\Bistability UP change power 2D forward 23-54-37\\drive frequency={drive_fre[i]}GHz\\Kappa_xiuzheng.txt')

...
omega_ps=8.25e9+np.linspace(-100,100,2001)*1e6
...
# ax1 = plt.subplot(231)
# gci1 = ax1.pcolor(phis,omega_ps/1e9, np.transpose(S12s1))
...
#
# ax2 = plt.subplot(232)
# gci2 = ax2.pcolor(phis, omega_ps/1e9,np.transpose(S21s1))
...
#
# ax3 = plt.subplot(233)
# gci3 = ax3.pcolor(phis, omega_ps/1e9,np.transpose(Isos1))

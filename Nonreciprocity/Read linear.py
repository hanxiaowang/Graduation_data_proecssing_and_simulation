...
#
# np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\Linear response\Error_max_dBm.txt',Errorbarmax)
# np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\Linear response\Error_max_mW.txt',Errorbar_mWmax)
#
# np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\Linear response\Error_min_dBm.txt',Errorbarmin)
# np.savetxt(r'C:\Users\AORUS\OneDrive\桌面\Linear response\Error_min_mW.txt',Errorbar_mWmin)

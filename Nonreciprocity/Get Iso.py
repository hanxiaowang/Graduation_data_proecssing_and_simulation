...
for i in range(len(voltage)):
    ...
    S12 = np.loadtxt(
        f'F:\\Nonreciprocity\\20210630\\S12\\20-110\\S\\S12 of coupling(experiment) with A={round(voltage[i])}.0 mV 2D.txt',
        delimiter=',')
    S21 = np.loadtxt(
        f'F:\\Nonreciprocity\\20210630\\S21\\20-110\\S\\S21 of coupling(experiment) with A={round(voltage[i])}.0 mV 2D.txt',
        delimiter=',')
...
np.savetxt(f'F:\\Nonreciprocity\\20210630\\Isore.txt',Iso)

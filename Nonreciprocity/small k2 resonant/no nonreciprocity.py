...
for i in range(len(omega_s)):
    ...
    S21.append(rf.mag_2_db(np.abs(t21))-33)
...
# axes.plot(fp,Sl21,'-',linewidth=10,c='green',alpha=0.4)
# axes.plot(fp,Ss21,'-',linewidth=10,c='green',alpha=0.4)
axes.plot(fp,Sr21,'-',linewidth=10,c='green',alpha=0.4)
# axes.plot(omega_s/1e9,S21,'--',linewidth=2)

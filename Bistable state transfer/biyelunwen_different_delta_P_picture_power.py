...
# #  2D演化图
forwardsin1=np.loadtxt(r'F:\change power\bistable date\Pd step=1mW\forwards.txt')
backwardsin1=np.loadtxt(r'F:\change power\bistable date\Pd step=1mW\backwards.txt')
evo_timesin1=np.loadtxt(r'F:\change power\bistable date\Pd step=1mW\evo_times.txt')
delta_Psin1=np.loadtxt(r'F:\change power\bistable date\Pd step=1mW\delta_Ps.txt')

forwardsin2=np.loadtxt(r'F:\change power\bistable date\Pd step=2mW\forwards.txt')
backwardsin2=np.loadtxt(r'F:\change power\bistable date\Pd step=2mW\backwards.txt')
evo_timesin2=np.loadtxt(r'F:\change power\bistable date\Pd step=2mW\evo_times.txt')
delta_Psin2=np.loadtxt(r'F:\change power\bistable date\Pd step=2mW\delta_Ps.txt')

...
# #  2D演化图
forwardsin1=np.loadtxt(r'F:\change power\bistable date\Pd step=5.0mW\forwards.txt')
backwardsin1=np.loadtxt(r'F:\change power\bistable date\Pd step=5.0mW\backwards.txt')
evo_timesin1=np.loadtxt(r'F:\change power\bistable date\Pd step=5.0mW\evo_times.txt')
delta_Psin1=np.loadtxt(r'F:\change power\bistable date\Pd step=5.0mW\delta_Ps.txt')
...
forwardsin3=np.loadtxt(r'F:\change power\bistable date\Pd step=0.0005mW\forwards.txt')
backwardsin3=np.loadtxt(r'F:\change power\bistable date\Pd step=0.0005mW\backwards.txt')
evo_timesin3=np.loadtxt(r'F:\change power\bistable date\Pd step=0.0005mW\evo_times.txt')
delta_Psin3=np.loadtxt(r'F:\change power\bistable date\Pd step=0.0005mW\delta_Ps.txt')
#

...
# #  2D演化图
# forwardsin1=np.loadtxt(r'F:\change power\bistable date\Pd step=0.0001mW\forwards.txt')
# backwardsin1=np.loadtxt(r'F:\change power\bistable date\Pd step=0.0001mW\backwards.txt')
# evo_timesin1=np.loadtxt(r'F:\change power\bistable date\Pd step=0.0001mW\evo_times.txt')
# delta_Psin1=np.loadtxt(r'F:\change power\bistable date\Pd step=0.0001mW\delta_Ps.txt')
#
# forwardsin2=np.loadtxt(r'F:\change power\bistable date\Pd step=0.01mW\forwards.txt')
# backwardsin2=np.loadtxt(r'F:\change power\bistable date\Pd step=0.01mW\backwards.txt')
# evo_timesin2=np.loadtxt(r'F:\change power\bistable date\Pd step=0.01mW\evo_times.txt')
# delta_Psin2=np.loadtxt(r'F:\change power\bistable date\Pd step=0.01mW\delta_Ps.txt')
#
# forwardsin3=np.loadtxt(r'F:\change power\bistable date\Pd step=1.0mW\forwards.txt')
# backwardsin3=np.loadtxt(r'F:\change power\bistable date\Pd step=1.0mW\backwards.txt')
# evo_timesin3=np.loadtxt(r'F:\change power\bistable date\Pd step=1.0mW\evo_times.txt')
# delta_Psin3=np.loadtxt(r'F:\change power\bistable date\Pd step=1.0mW\delta_Ps.txt')
#
forwardsin4=np.loadtxt(r'F:\change power\bistable date\Pd step=10.0mW\forwards.txt')
backwardsin4=np.loadtxt(r'F:\change power\bistable date\Pd step=10.0mW\backwards.txt')
evo_timesin4=np.loadtxt(r'F:\change power\bistable date\Pd step=10.0mW\evo_times.txt')
delta_Psin4=np.loadtxt(r'F:\change power\bistable date\Pd step=10.0mW\delta_Ps.txt')

end_point=1e7
middle_number=400
plt.figure(figsize=(8,6))
ax1 = plt.subplot(111)
# ax1.plot(evo_timesin1[0:int(end_point):middle_number], forwardsin1[0:int(end_point):middle_number], 's',  markersize=4, color='blue',label=r'$\Delta P_d=0.0001$ mW',markerfacecolor='None')
# ax1.plot(evo_timesin2[0:int(end_point):middle_number], forwardsin2[0:int(end_point):middle_number], 's',  markersize=4, color='blue',label=r'$\Delta P_d=0.01$ mW',markerfacecolor='None')
# ax1.plot(evo_timesin3[0:int(end_point):middle_number], forwardsin3[0:int(end_point):middle_number], 's',  markersize=4, color='blue',label=r'$\Delta P_d=1$ mW',markerfacecolor='None')
ax1.plot(evo_timesin4[0:int(end_point):middle_number], forwardsin4[0:int(end_point):middle_number], 's',  markersize=4, color='blue',label=r'$\Delta P_d=10$ mW',markerfacecolor='None')
...
plt.figure(figsize=(8,6))
ax1 = plt.subplot(111)
# ax1.plot(evo_timesin1[0:int(end_point):middle_number], backwardsin1[0:int(end_point):middle_number], 's',  markersize=4, color='red',label=r'$\Delta P_d=0.0001$ mW',markerfacecolor='None')
# ax1.plot(evo_timesin2[0:int(end_point):middle_number], backwardsin2[0:int(end_point):middle_number], 's',  markersize=4, color='red',label=r'$\Delta P_d=0.01$ mW',markerfacecolor='None')
# ax1.plot(evo_timesin3[0:int(end_point):middle_number], backwardsin3[0:int(end_point):middle_number], 's',  markersize=4, color='red',label=r'$\Delta P_d=1$ mW',markerfacecolor='None')
ax1.plot(evo_timesin4[0:int(end_point):middle_number], backwardsin4[0:int(end_point):middle_number], 's',  markersize=4, color='red',label=r'$\Delta P_d=10$ mW',markerfacecolor='None')

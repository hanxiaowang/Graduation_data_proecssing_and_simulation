...
jump_time=2.9e5
##总2e5
M_srf,M_sif,A_srf,A_sif,Timeu=Bistability(**para).m_a_evo_and_back_f(msf[-2],asf[-2],1e-11,jump_time,forwardf[-1],6e5-jump_time,forwardf[-2],P)
M_srb,M_sib,A_srb,A_sib,Timeb=Bistability(**para).m_a_evo_and_back_f(msb[1],asb[1],1e-11,jump_time,backwardf[0],6e5-jump_time,backwardf[1],P)
Excitionf = M_srf ** 2 + M_sif ** 2
Excitionb = M_srb ** 2 + M_sib ** 2
middle_number=20
plt.figure(figsize=(8, 6))
axes1 = plt.subplot(111)
axes1.plot(Timeu[::middle_number], Excitionf[::middle_number], 's',  markersize=4, label=r'$[m,W \longrightarrow X]$',markerfacecolor='None',color='fuchsia')
# plt.xlim(xsmall1,xlarge1)
plt.legend(loc=0,fontsize=10)
plt.show()
plt.figure(figsize=(8, 6))
axes1 = plt.subplot(111)
axes1.plot(Timeu[::middle_number], Excitionb[::middle_number], 's',  markersize=4, label=r'$[m,Y \longrightarrow Z]$',markerfacecolor='None',color='fuchsia')
# plt.xlim(xsmall1,xlarge1)
plt.legend(loc=0,fontsize=10)
plt.show()
...
#         ##总2e5
#         M_srf,M_sif,A_srf,A_sif,Timeu=Bistability(**para).m_a_evo_and_back(msf[-2],asf[-2],1e-11,jump_time,forwardf[-1],2e5-jump_time,forwardf[-2],f)
#         M_srb,M_sib,A_srb,A_sib,Timeb=Bistability(**para).m_a_evo_and_back(msb[1],asb[1],1e-11,jump_time,backwardf[0],2e5-jump_time,backwardf[1],f)

...
#
#
# forwardsin3=np.loadtxt(r'f:\change fre\bistable date\fd step=1000.0kHz\forwards.txt')
# backwardsin3=np.loadtxt(r'f:\change fre\bistable date\fd step=1000.0kHz\backwards.txt')
# evo_timesin3=np.loadtxt(r'f:\change fre\bistable date\fd step=1000.0kHz\evo_times.txt')
# delta_Psin3=np.loadtxt(r'f:\change fre\bistable date\fd step=1000.0kHz\delta_fs.txt')
...
# ax1.plot(evo_timesin2[::middle_number], forwardsin2[::middle_number], 's',  markersize=4, label=r'$Re[m,W \longrightarrow X],1kHz$',markerfacecolor='None')
# ax1.plot(evo_timesin3[::middle_number], forwardsin3[::middle_number], 's',  markersize=4, label=r'$Re[m,W \longrightarrow X],100kHz$',markerfacecolor='None')
#
...
# ax1.plot(evo_timesin2[::middle_number], backwardsin2[::middle_number], 's',  markersize=4, label=r'$Re[m,Y \longrightarrow Z],1kHz$',markerfacecolor='None')
# ax1.plot(evo_timesin3[::middle_number], backwardsin3[::middle_number], 's',  markersize=4, label=r'$Re[m,W \longrightarrow X],100kHz$',markerfacecolor='None')
# ax1.set_xlabel(r'$times$ [s]',fontsize=20)
# ax1.set_ylabel(r'$\Delta_+/2\pi$',fontsize=20)
# plt.tick_params(labelsize=20)
# plt.legend()
